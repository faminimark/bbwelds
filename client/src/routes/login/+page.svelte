...
<div class="grid grid-cols-2 max-md:flex max-md:flex-col-reverse max-md:h-screen max-md:justify-end">
    <div class="bg-emerald-800 text-white p-15 flex flex-col gap-10 max-sm:hidden">
    ...
    <div class="flex flex-col gap-7 p-6">
        <a href="/register" class="font-bold border-1 border-black rounded-2xl p-3 w-[120px] text-center self-end hidden max-sm:block">Sign up</a>
